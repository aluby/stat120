...
-   When I'm not working or chasing Ellis around, I like to read and am trying to do more fiber crafts
:::
...
::: {.nonincremental}
- Introduce yourselves: name, pronouns, year, academic interest, personal interest
- Share a bit about why you’re taking this class
:::
...
-   Homework will be assigned once per week, due on gradescope by 10pm on Wednesday (Friday in week 1, 4, 7, 9)
-   No-questions-asked 12 hour grace period if you need it 
    - (grace period = no penalty, but help is generally not available)
...
- While I believe most of your learning in this course will happen through working together in class, doing your homework, and putting together your project, part of being literate in statistics is being able to recall basic concepts and interpret analyses "on the fly", without access to other resources
...
**Ed** is an asychronous communication platform where you can also ask homework questions anytime! I'll respond to messages at least twice per weekday. If you see someone ask a question that *you* know the answer to, please respond! 
...
| Wednesday | 9:30-10:30^[Stat120 Priority]   | Drop-in | CMC 307  |
| Friday    | 10-11^[Stat230 Priority]       | Drop-in | CMC 307  |

## Communication

::: {.fragment .nonincremental}
- Moodle: assignments, slides, and grades
- Ed: homework questions, announcements, discussion
- Email: personal matters, time-sensitive announcements
:::

::: {.fragment}
**Ed** is the fastest way to reach me. I typically will respond to messages 2x per weekday. I try to respond to emails within 48 hours. I'm online sporadically on evenings and weekends to devote time to family and rest -- I hope you also use this time to reset and recharge! 
:::
...
:::: {layout="[1, 1]" style="font-size: 1.5em;"}
...
![](img/horst-categorical-vars.ppm)

##

![](img/horst-quant-vars.ppm)
...
- Prep work to do *before* Wednesday's class
