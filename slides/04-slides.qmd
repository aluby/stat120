...
Categorical variables are best summarized with a **frequency table** and visualized with a **barplot**. 
...
## Choose the right plot: Which slice is the biggest/smallest?
...
## Relevant **parameter**: Proportion

When we want to summarize a categorical variable with a single number, we often use a proportion

::: callout-note
## Proportion  (or percentage)

$$\widehat{p} = \frac{\text{The number within a category}}{\text{Total number}}$$

We use $p$ if this denotes a population proportion, or $\widehat{p}$ if it denotes a sample proportion
:::
...
**Example:** Is penguin species independent of island? How can you tell? 
