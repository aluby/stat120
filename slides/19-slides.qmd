...
ggplot(data = data.frame(x = seq(-4,4,by=.1)), aes(x)) +
  ...
  geom_area(stat = "function", fun = dnorm, fill = "#ED7953FF", xlim = c(-5, -2)) +
  geom_area(stat = "function", fun = dnorm, fill = "#ED7953FF", xlim = c(2,5)) 
```
...
ggplot(data = data.frame(x = seq(-4,4,by=.1)), aes(x)) +
  ...
  scale_y_continuous(breaks = NULL) + 
  scale_x_continuous(breaks= -3:3) + 
  geom_area(stat = "function", fun = dnorm, fill = "#ED7953FF", xlim = c(-5, -1)) +
  geom_area(stat = "function", fun = dnorm, fill = "#ED7953FF", xlim = c(1,5)) 
```

```{r}
#| echo: true
qnorm(.16, lower.tail = TRUE)
```
...
ggplot(data = data.frame(x = seq(-4,4,by=.1)), aes(x)) +
  ...
  scale_y_continuous(breaks = NULL) + 
  scale_x_continuous(breaks= -3:3) + 
  geom_area(stat = "function", fun = dnorm, fill = "#ED7953FF", xlim = c(-5, -2.56)) +
  geom_area(stat = "function", fun = dnorm, fill = "#ED7953FF", xlim = c(2.56,5)) 
```

```{r}
#| echo: true
qnorm(.005, lower.tail = TRUE)
```
...
**Example 1:** $\widehat{p} = .5$. How big is "big enough"? (StatKey)

. . . 

**Example 2:** $\widehat{p} = .05$. How big is "big enough"? (StatKey)
...
- $SE_{\widehat{p}} = \sqrt{\frac{p_0(1-p_0)}{n}}$
