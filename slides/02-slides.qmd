...
![](wordcloud-2.png){fig-align="center"}

```{r, echo = FALSE}
survey = read_csv("../data/survey-anon.csv", 
                  col_names = c("stats", "cs", "r", "rstudio", "rmarkdown", "nervous"),
                  skip = 1)
```
...
3. If you have time, talk about the examples we didn't get to in Notes01. 
