...
```{webr}
library(dplyr)
mission_data = read.csv("https://raw.githubusercontent.com/aluby/stat120/refs/heads/main/data/mission_data.csv") #read.csv("https://aluby.github.io/stat120/data/mission_data.csv")
```
