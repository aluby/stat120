...
(a) What is the standard error for each of these estimates? 

\vspace{1in}

(b) Build a 95% confidence interval for one of these proportions

\vspace{2in}

(dc Use the normal distribution to build a **99%** confidence interval for one of these proportions
