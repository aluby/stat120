...
We'll start by revisiting the StatKey questions from last week (problems assigned by group on board). Once your group feels good about your answer, fill out OR review the [collaborative key google doc](https://docs.google.com/document/d/1zniPpx5ChShkCzQxnJLO00TLZ-trsv9b2Jo1uXJMAP4/edit?usp=sharing) 
...
**4.** Create a bootstrap distribution of the difference in proportions and give a sentence interpreting the 95% percentile interval. Use the variable `values2`, which is recoded so that 1 = "good", 0 = "bad".
