...
The first thing you'll have to do is choose the right menu from StatKey. For example, if you are trying to make a confidence interval for a proportion, you will need to be in the “proportion” menu under “Bootstrap confidence intervals”. 
