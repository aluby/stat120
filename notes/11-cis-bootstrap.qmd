...
p1 <- gf_histogram(~phats_5, bins = 10, col = "white", fill = "black", xlab = "n=5", alpha = .7, boundary = 0) +  scale_x_continuous(breaks = seq(0,1,by=.2), limits = c(0,1))

p2 <- gf_histogram(~phats_20, bins = 12, col = "white", fill = "black", xlab = "n=20", alpha = .7, boundary = 0) + scale_x_continuous(breaks = seq(0,1,by=.2), limits = c(0,1))
