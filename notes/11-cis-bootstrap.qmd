...
Let's begin with the class proportion from last time: 36.7% of Carleton students are "from the Midwest", while ____% of our class (who answered) are from the Midwest. 
...
carls = tibble(
  student_id = 1:2007,
  midwest = c(rep("Yes", 737), rep("No", 2007-737))
) %>% 
  slice(sample(1:n()))
