...
These solutions are provided solely for Carleton College students enrolled in Amanda Luby’s Stat120 course in Spring 2026. Dissemination of this solution to any other person will be considered grounds for an Academic Dishonesty report for all individuals involved in the giving and receiving of the solution.
:::
...
On average, states with a 1% increase in percent of students who took the SAT also tend to have an average score that is 1.14 points lower.
:::
...
::: callout-note
- Epsilon $\approx$ 30, y hat $\approx$ 563 (read from residual scatterplot) 
- y $\approx$ 593 (since $\epsilon = y - \hat y$) 
- Since $\hat y = b_0 + b_1x$ we can find this with the regression equation: $563 = 572.21 - 1.14x \to x = 8.08$
:::
...
::: callout-note
This interval was found by using the 68/95/99 rule, which gives what percent of a bell curve will be within 1/2/3 standard deviations of the mean respectively. Since it is a 95% interval, use 2 standard deviations.
...
The result means that, if the 68/95/99 rule holds, 95% of the data points would have a value between 23.44 and 48.34.
:::
